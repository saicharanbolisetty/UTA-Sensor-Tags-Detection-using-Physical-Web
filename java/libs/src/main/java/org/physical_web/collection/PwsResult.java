...
public class PwsResult {
  ...
  public String getSiteUrl() {
    ...
    switch (id){
      case "001":
        ...
        break;
      case "002":
        url= "https://oneplus.net/3t";
        break;
      case "003":
        url= "https://www.raspberrypi.org/products/raspberry-pi-3-model-b/";
        break;
      case "004":
        url= "http://www.dell.com/en-us/gaming/alienware-laptops?cs=19";
        break;
      case "005":
        url= "https://www.amazon.com/Amazon-Echo-Bluetooth-Speaker-with-WiFi-Alexa/dp/B00X4WHP5E";
        break;
      case "006":
        url= "https://www.google.com/intl/en_us/chromecast/?utm_source=chromecast.com";
        break;
      case "007":
        url= "http://www.razerzone.com/gaming-keyboards-keypads/razer-deathstalker-ultimate";
        break;
      case "008":
        url= "https://steelseries.com/gaming-mice/rival-700";
        break;
      case "009":
        url= "https://www.netgear.com/landings/ad7200/?cid=wmt_netgear_organic";
        break;
      case "010":
        url= "http://www.samsung.com/us/computing/memory-storage/solid-state-drives/ssd-850-evo-25-sata-iii-4tb-mz-75e4t0b-am/";
        break;
        default:
  ...
  public String getTitle() {
    ...
    switch (id){
      ...
      case "007":
        ...
        break;
      case "008":
        title= "Steelseries Rival";
        break;
      case "009":
        title= "Netgear 802.11ad Router";
        break;
      case "010":
        title= "Samsung SSD";
        break;
  ...
  public String getDescription() {
    ...
    String iddes=getId(mRequestUrl);
    String mDescription;
    switch (iddes){
      case "001":
        mDescription= "iPad Pro is more than the next generation of iPad — it’s an uncompromising vision of personal computing for the modern world.";
        break;
      case "002":
        mDescription= "The OnePlus 3T stays true to our Never Settle approach. Impressive specs mean nothing if you don’t have a great experience every time you pick up your phone.";
        break;
      case "003":
        mDescription= "The Raspberry Pi 3 has an identical form factor to the previous Pi 2 (and Pi 1 Model B+) and has complete compatibility with Raspberry Pi 1 and 2.";
        break;
      case "004":
        mDescription= "Alienware 13, 15 and 17 redefine what it means to game with jaw-dropping power.";
        break;
      case "005":
        mDescription= "Plays all your music from Amazon Music, Spotify, Pandora, iHeartRadio, TuneIn, and more using just your voice.";
        break;
      case "006":
        mDescription= "Stream up to 4K Ultra HD & HDR picture quality over your WiFi network with Chromecast Ultra, a streaming device that plugs into your TV’s HDMI port. Chromecast Ultra provides fast, reliable performance with minimal buffering and smoother streaming.";
        break;
      case "007":
        mDescription= "Razer’s award-winning, proprietary Switchblade User Interface puts more control in your hands with ten dynamic adaptive tactile keys and an LCD panel. ";
        break;
      case "008":
        mDescription= "The mouse is no longer merely an input device; gamers can now feel in‐game events, aiding them in critical decision‐making. Customize every aspect of the alerts from intensity to vibration patterns.";
        break;
      case "009":
        mDescription= "Don't wait to watch! Experience ultra-smooth, lag-free WiFi experience for 4K video streaming and VR gaming.";
        break;
      case "010":
        mDescription= "The Samsung SSD 850 EVO elevates the everyday computing experience to a higher level of performance and endurance than was ever imagined. ";
        break;
      default:
        mDescription= "GOOGLE";
        break;
